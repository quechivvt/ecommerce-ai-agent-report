...
\subsection{ERD chi tiết cho user service}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{images/erd/user-service.png}
    \vspace{0.5cm}
...
\subsection{ERD chi tiết cho order service}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{images/erd/order-service.png}
    \vspace{0.5cm}
...
\subsection{ERD chi tiết cho product service}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{images/erd/product-service.png}
    \vspace{0.5cm}
...
\subsection{ERD chi tiết cho cart service}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{images/erd/cart-service.png}
    \vspace{0.5cm}
    \caption{ERD chi tiêt của cart service}
    \label{fig:cart-service}
\end{figure}

\subsection{ERD chi tiết cho admin service}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/erd/admin-service.png}
    \vspace{0.5cm}
