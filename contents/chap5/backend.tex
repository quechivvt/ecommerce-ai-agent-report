\subsection{Ngăn xếp công nghệ Backend}

Ngăn xếp công nghệ của hệ thống thương mại điện tử cho bán lẻ điện thoại tích hợp trợ lý ảo AI Agent của nhóm được lựa chọn một cách cẩn trọng nhằm đáp ứng trọn vẹn định hướng kiến trúc hiện đại và tối ưu hóa hiệu suất.  
