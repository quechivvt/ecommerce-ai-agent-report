...
\item \textbf{[FR1] Đăng ký} \quad (\textit{Ưu tiên: Cao})\\
...
\item \textbf{[FR10] Hủy đơn hàng} \quad (\textit{Ưu tiên: Trung bình})\\
    Cho phép khách hàng hủy đơn hàng nếu đơn hàng đáp ứng được các điều kiện ràng buộc.

\item \textbf{[FR11] Trợ lý Ảo (Tìm kiếm/gợi ý)} \quad (\textit{Ưu tiên: Cao})\\
...
\item \textbf{[FR12] Trợ lý Ảo (Tư vấn FAQ)} \quad (\textit{Ưu tiên: Cao})\\
...
\item \textbf{[FR13] Trợ lý Ảo (Hỗ trợ sau mua)} \quad (\textit{Ưu tiên: Trung bình})\\
...
\item \textbf{[FR14] Lịch sử \& Theo dõi đơn hàng} \quad (\textit{Ưu tiên: Cao})\\
    Cho phép khách hàng xem lịch sử đơn hàng và theo dõi trạng thái đơn hàng đang xử lý hoặc vận chuyển.

\item \textbf{[FR15] Đánh giá} \quad (\textit{Ưu tiên: Trung bình})\\
...
\begin{itemize}
    \item \textbf{[FR16] Phân quyền Người dùng} \quad (\textit{Ưu tiên: Cao})\\
...
\item \textbf{[FR17] Quản lý Sản phẩm} \quad (\textit{Ưu tiên: Cao})\\
    Giao diện quản trị cho phép thêm, chỉnh sửa, xóa sản phẩm, cập nhật giá và quản lý các chương trình khuyến mãi.

\item \textbf{[FR18] Báo cáo Cơ bản} \quad (\textit{Ưu tiên: Trung bình})\\
...
\item \textbf{[FR19] Cập nhật Trạng thái Đơn hàng} \quad (\textit{Ưu tiên: Cao})\\
