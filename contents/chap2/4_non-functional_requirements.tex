...
\item \textbf{[NFR1] Hiệu năng của phản hồi chung} \quad (\textit{Ưu tiên: Cao})\\
...
\item \textbf{[NFR6] Chất lượng giao tiếp của trợ lý ảo} \quad (\textit{Ưu tiên: Cao})\\
...
\begin{itemize}
    \item \textbf{[NFR7] Độ ổn định dịch vụ} \quad (\textit{Ưu tiên: Trung bình})\\
...
\item \textbf{[NFR8] Bảo mật dữ liệu người dùng} \quad (\textit{Ưu tiên: Cao})\\
...
\item \textbf{[NFR9] Khả năng mở rộng} \quad (\textit{Ưu tiên: Trung bình})\\
...
\item \textbf{[NFR10] Hiệu suất báo cáo admin} \quad (\textit{Ưu tiên: Thấp})\\
...
\item \textbf{[NFR11] Tính toàn vẹn} \quad (\textit{Ưu tiên: Cao})\\
