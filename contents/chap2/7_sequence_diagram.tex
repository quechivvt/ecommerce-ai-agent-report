...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/sequence_diagram/register.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/sequence_diagram/login.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/sequence_diagram/forgot_password.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/sequence_diagram/manage_personal_information.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{images/sequence_diagram/find_product.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{images/sequence_diagram/add_to_cart_and_checkout.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/sequence_diagram/multiple_payment_method.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/sequence_diagram/view_order_status.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/sequence_diagram/cancel_order.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/sequence_diagram/customer_feedback.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/sequence_diagram/shopping_consulting.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/sequence_diagram/place_order_support.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/sequence_diagram/shopping_support.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/sequence_diagram/cancel_order_support.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{images/sequence_diagram/manage_product.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/sequence_diagram/change_order_status.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/sequence_diagram/view_basic_report.png}
