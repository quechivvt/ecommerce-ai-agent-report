...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{images/activity_diagram/register.png}
   \vspace{0.5cm} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{images/activity_diagram/login.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{images/activity_diagram/forgot_password.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{images/activity_diagram/manage_personal_information.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/activity_diagram/find_product.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/activity_diagram/add_to_cart_and_checkout.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/activity_diagram/multiple_payment_method.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/activity_diagram/view_order_status.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{images/activity_diagram/cancel_order.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/activity_diagram/shopping_consulting.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/activity_diagram/place_order_support.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/activity_diagram/shopping_support.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/activity_diagram/cancel_order_support.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{images/activity_diagram/customer_feedback.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/activity_diagram/manage_product.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/activity_diagram/change_order_status.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/activity_diagram/view_basic_report.png}
