...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/chap6/erd/new-orchestration-erd.png}
    \vspace{0.5cm}
...
Admin Service đóng vai trò hỗ trợ các nghiệp vụ quản trị và giám sát hoạt động của hệ thống thông qua việc quản lý báo cáo, lưu trữ thông tin liên hệ và ghi nhận lịch sử thao tác của quản trị viên. Dịch vụ này hỗ trợ quá trình theo dõi hệ thống, đồng thời cung cấp cơ chế quản lý dữ liệu phục vụ cho hoạt động vận hành và tương tác với người dùng.

Thực thể AdminActionLog chịu trách nhiệm lưu trữ lịch sử thao tác của quản trị viên, bao gồm loại hành động thực hiện, đối tượng tác động và các thông tin mô tả liên quan nhằm phục vụ mục đích kiểm tra và truy vết hệ thống. Thực thể Report quản lý thông tin các báo cáo được tạo ra như loại báo cáo, tên và liên kết đến tệp kết quả. Ngoài ra, thực thể Subscriber lưu trữ danh sách người dùng đăng ký nhận báo cáo định kỳ, trong khi ContactInfo quản lý các thông tin liên hệ và phản hồi được gửi đến hệ thống.

Hình \ref{fig:admin-service} mô tả mối quan hệ giữa các thực thể trong dịch vụ quản trị. Cụ thể, một Subscriber có thể tạo nhiều Report, thể hiện quan hệ một - nhiều giữa hai thực thể. Đồng thời, AdminActionLog lưu trữ lịch sử thao tác của quản trị viên nhằm hỗ trợ giám sát hoạt động hệ thống và nâng cao khả năng kiểm soát dữ liệu.

\begin{figure}[H]
\centering
\includegraphics[width=0.9\linewidth]{images/chap6/erd/new-admin-service-erd.png}
\vspace{0.5cm}
\caption{ERD chi tiết của admin service}
