...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{images/chap6/ui/ui_login.png}
    \vspace{0.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\linewidth]{images/chap6/ui/ui_home.png}
    \vspace{0.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{images/chap6/ui/ui_product_filter.png}
    \vspace{0.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{images/chap6/ui/ui_product_detail.png}
    \vspace{0.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{images/chap6/ui/ui_cart.png}
    \vspace{0.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{images/chap6/ui/ui_shipping_detail.png}
    \vspace{0.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{images/chap6/ui/ui_view_profile_profile.png}
    \vspace{0.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{images/chap6/ui/ui_list_of_order.png}
    \vspace{0.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\linewidth]{images/chap6/ui/ui_tracking_order.png}
    \vspace{0.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{images/chap6/ui/ui_admin_home.png}
    \vspace{0.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{images/chap6/ui/ui_admin_product.png}
    \vspace{0.5cm}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\linewidth]{images/chap6/ui/ui_order_management.png}
    \vspace{0.5cm}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.75\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/bonus_report/date_revenue.png}
        \vspace{0.1cm}
        \caption*{(a) Xu hướng doanh thu theo ngày}
    \end{minipage}
    \vspace{0.3cm}

    \begin{minipage}[t]{0.75\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/bonus_report/month_revenue_and_top_products.png}
        \vspace{0.1cm}
        \caption*{(b) Doanh thu theo tháng và Sản phẩm bán chạy}
    \end{minipage}
    \vspace{0.3cm}
    \caption{Giao diện Báo cáo thống kê (Analytics Dashboard)}
    \label{fig:ui_report_management}
\end{figure}
Giao diện báo cáo thống kê cung cấp các biểu đồ trực quan về xu hướng doanh thu theo ngày, tháng và danh sách các sản phẩm bán chạy nhất, giúp ban quản trị dễ dàng theo dõi hiệu quả kinh doanh.
