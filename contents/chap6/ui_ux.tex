...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.48\linewidth}
        ...
        \vspace{0.5cm}
        \caption*{(a) Nội dung giới thiệu doanh nghiệp}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\linewidth}
        \centering
        ...
        \vspace{0.5cm}
        \caption*{(b) Số liệu và đánh giá khách hàng}
    \end{minipage}
    \vspace{1cm}
...
\begin{figure}[H]
   ...
   \vspace{0.5cm} \caption{Giao diện Danh sách và Bộ lọc sản phẩm}
    \label{fig:ui_filter}
\end{figure}
Giao diện danh mục sản phẩm tích hợp bộ lọc nâng cao (Sidebar Filter). Người dùng có thể lọc theo: Khoảng giá, Thương hiệu (Apple, Samsung, Dell...), Đánh giá sao, Loại sản phẩm
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/chap6/ui/ui_view_profile_address.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/chap6/ui/ui_view_profile_bank.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/chap6/ui/ui_view_profile_change_password.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/chap6/ui/ui_order_detail.png}
...
\begin{figure}[H]
   ...
   \vspace{0.5cm} \caption{Giao diện Theo dõi đơn hàng}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/chap6/ui/ui_give_feedback.png}
