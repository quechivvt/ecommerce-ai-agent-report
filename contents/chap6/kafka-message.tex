...
Các microservice không gọi trực tiếp sang nhau khi xử lý nghiệp vụ phức tạp. Thay vào đó:
...
\textbf{e/ Payment Service} \\
\textbf{Topic:} \texttt{payment-events}
\begin{itemize}
    \item PaymentRequested
    \item PaymentSucceeded
    \item PaymentFailed
    \item RefundIssued
\end{itemize}
