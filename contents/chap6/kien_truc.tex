...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/chap6/FrontendArchitecture.png}
    \vspace{0.5cm}
...
\begin{itemize}
    ...
    \item \textbf{State Management Partitioning:} 
        ...
        \end{itemize}
    \item \textbf{AI Chat Integration:} Thành phần Chatbot được thiết kế theo kiến trúc streaming. Sử dụng Vercel AI SDK để duy trì trạng thái hội thoại và xử lý luồng dữ liệu Server-Sent Events (SSE) từ AI Agent Service, đảm bảo phản hồi được hiển thị theo thời gian thực (token-by-token).
\end{itemize}
