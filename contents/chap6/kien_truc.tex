...
Sơ đồ \ref{fig:component_diagram} biểu diễn các thành phần công nghệ cốt lõi và luồng giao tiếp thực tế của hệ thống. Do vai trò và chức năng nghiệp vụ của các tầng đã được trình bày chi tiết ở mục trước, phần này tập trung tóm tắt các công nghệ và nền tảng chính được áp dụng cho từng thành phần:
