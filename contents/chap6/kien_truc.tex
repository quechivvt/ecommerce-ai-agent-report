...
Riêng AI agent service sở hữu hai cơ sở dữ liệu độc lập: cơ sở dữ liệu Vector và cơ sở dữ liệu Graph, tương ứng với hai loại dữ liệu mà service này cần quản lý. Điều này cho phép dịch vụ Trợ lý Ảo vận hành trên những tập dữ liệu phù hợp với nhu cầu xử lý của nó.
