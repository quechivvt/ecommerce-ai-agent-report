...
Dữ liệu sản phẩm được thu thập từ website \texttt{CellPhones.com.vn}. Đây là dữ liệu của toàn bộ hệ thống, dùng cho các quy trình nghiệp vụ của web app chính và phục vụ vai trò knowledge base cho hệ thống tìm kiếm và tư vấn --- không dùng để huấn luyện mô hình. Tập dữ liệu thu được gồm 898 sản phẩm, 1.692 biến thể, 35 thương hiệu và 189 dòng sản phẩm thuộc 7 danh mục: điện thoại, máy tính bảng, laptop, màn hình, máy in, micro thu âm và tivi.
