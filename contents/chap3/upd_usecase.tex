...
Nhằm tối ưu hóa dung lượng của báo cáo và tập trung vào các đặc thù công nghệ của hệ thống, trong phạm vi chương này, nhóm trình bày các mô tả cho những trường hợp sử dụng cốt lõi, bao gồm các nghiệp vụ tìm kiếm sản phẩm, thêm sản phẩm vào giỏ hàng, đặt hàng, thanh toán và các luồng tương tác thông minh với trợ lý ảo AI thông qua các bảng \ref{tab:uc-search-product}, \ref{tab:uc-add-to-cart-checkout}, \ref{tab:uc-multipayment}, \ref{tab:uc-customer-review}, \ref{tab:uc-admin-basic-reports}, \ref{tab:uc-product-suggestion} và bảng \ref{tab:uc-post-purchase-support}. Các bảng mô tả chi tiết cho các chức năng quản trị và những nghiệp vụ hỗ trợ khác được trình bày đầy đủ tại phần phụ lục \ref{sec:appx_usecase_detail} của đồ án.
...
5. Khách hàng có tài khoản và đã đăng nhập. \\
\hline
...
6. Khách hàng có tài khoản và đã đăng nhập. \\
\hline
...
\hline
\textbf{Tóm tắt mô tả} & AI ChatBot cung cấp thông tin, tư vấn và giải đáp thắc mắc liên quan đến đơn hàng trong quá trình xử lý hoặc sau khi đã hoàn tất. \\
\hline
\textbf{Tác nhân} & Khách hàng. \\
\hline
\textbf{Tiền điều kiện} & 1. Hệ thống hoạt động bình thường. \newline
