...
Các hình từ \ref{fig:seq_find_product} đến \ref{fig:seq_shopping_support} trình bày các sơ đồ hoạt động cho những trường hợp sử dụng cốt lõi của hệ thống. Các sơ đồ còn lại sẽ được biểu diễn ở phần phụ lục \ref{sec:appx_activity_diagram}.
...
\end{figure}
Quy trình xử lý các khiếu nại hoặc yêu cầu bảo hành. Trợ lý ảo truy xuất thông tin về chính sách trên hệ thống và trả về kết quả xử lý hỗ trợ.
