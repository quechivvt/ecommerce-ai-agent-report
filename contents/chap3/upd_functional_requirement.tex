...
\item \textbf{[FR2] Đăng nhập/Đăng xuất} \hfill (\textit{Ưu tiên: Cao})\\
    Cho phép khách hàng đăng nhập bằng tài khoản đã đăng ký hoặc tài khoảng Google và đăng xuất khỏi hệ thống.

\item \textbf{[FR3] Quên mật khẩu} \hfill (\textit{Ưu tiên: Trung bình})\\
    Cung cấp cho khách hàng phương thức lấy lại mật khẩu trong trường hợp khách hàng quên mật khẩu.

\item \textbf{[FR4] Quản lí hồ sơ} \hfill (\textit{Ưu tiên: Thấp})\\
    Cho phép khách hàng thêm và sửa đổi hồ sơ thông tin cá nhân của bản thân.

\item \textbf{[FR5] Tìm kiếm và lọc} \hfill (\textit{Ưu tiên: Cao})\\
    Cung cấp chức năng tìm kiếm sản phẩm theo tên và lọc sản phẩm theo tiêu chí như giá, cấu hình và khuyến mãi.

\item \textbf{[FR6] Giỏ hàng và đặt hàng} \hfill (\textit{Ưu tiên: Cao})\\
    Cho phép khách hàng thêm sản phẩm vào giỏ hàng, chỉnh sửa và tiến hành đặt hàng.

\item \textbf{[FR7] Đa phương thức thanh toán} \hfill (\textit{Ưu tiên: Trung bình})\\
    Hỗ trợ đa phương thức thanh toán, bao gồm thẻ ngân hàng và ví điện tử.

\item \textbf{[FR8] Thông tin sản phẩm minh bạch} \hfill (\textit{Ưu tiên: Cao})\\
...
\item \textbf{[FR9] Hủy đơn hàng} \hfill (\textit{Ưu tiên: Trung bình})\\
    Cho phép khách hàng hủy đơn hàng nếu đơn hàng đáp ứng được các điều kiện ràng buộc.

\item \textbf{[FR10] Trợ lý ảo (Tìm kiếm/gợi ý)} \hfill (\textit{Ưu tiên: Cao})\\
...
\item \textbf{[FR11] Trợ lý ảo (Tư vấn FAQ)} \hfill (\textit{Ưu tiên: Cao})\\
...
\item \textbf{[FR12] Lịch sử và theo dõi đơn hàng} \hfill (\textit{Ưu tiên: Cao})\\
    Cho phép khách hàng xem lịch sử đơn hàng và theo dõi trạng thái đơn hàng đang xử lý hoặc vận chuyển.

\item \textbf{[FR13] Đánh giá} \hfill (\textit{Ưu tiên: Trung bình})\\
...
\begin{itemize}
\item \textbf{[FR14] Phân quyền người dùng} \hfill (\textit{Ưu tiên: Cao})\\
...
\item \textbf{[FR15] Quản lý sản phẩm} \hfill (\textit{Ưu tiên: Cao})\\
    Giao diện quản trị cho phép thêm, chỉnh sửa, xóa sản phẩm, cập nhật giá và quản lý các chương trình khuyến mãi.

\item \textbf{[FR16] Báo cáo cơ bản} \hfill (\textit{Ưu tiên: Trung bình})\\
...
\item \textbf{[FR17] Cập nhật trạng thái đơn hàng} \hfill (\textit{Ưu tiên: Cao})\\
