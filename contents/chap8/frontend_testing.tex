...
\subsubsection{Kiểm thử thủ công và trải nghiệm người dùng}
...
1 & Auth & Logic Đăng nhập, Đăng ký, Quên mật khẩu & 22 & 0 & 22 \\ \hline
2 & Product & Hiển thị danh sách, Bộ lọc, Chi tiết sản phẩm & 34 & 0 & 34 \\ \hline
3 & Cart & Thêm/Xóa sản phẩm, Cập nhật số lượng & 27 & 0 & 27 \\ \hline
4 & Order & Luồng thanh toán, Theo dõi đơn hàng & 40 & 0 & 40 \\ \hline
5 & AI Chatbot & Gửi nhận tin nhắn, Hiển thị card sản phẩm & 9 & 0 & 9 \\ \hline
6 & Core UI \& Utils & Các component dùng chung, Hooks, Utilities & 193 & 0 & 193 \\ \hline
\multicolumn{3}{|c|}{\textbf{TỔNG CỘNG FRONTEND}} & \textbf{325} & \textbf{0} & \textbf{325} \\ \hline
\end{tabular}
\vspace{10pt}
...
\begin{figure}[H]
    ...
    \vspace{10pt}
    \caption{Kết quả thực thi 325 test cases bằng Vitest}
    \label{fig:vitest_results}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/chap8/testing/coverage_dashboard.png}
    \vspace{10pt}
