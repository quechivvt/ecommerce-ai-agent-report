...
Integration & REST API & 11 & 11/11 (100\%) \\
\hline
\end{tabular}
...
\begin{itemize}
\item Hit@1: Từ khóa có trong kết quả trả về đầu tiên
\item Hit@3: Từ khóa có trong top 3 kết quả trả về
\end{itemize}
...
Multi-turn chat & hội thoại nhiều bước & PASS \\
\hline
\end{tabular}
...
11/11 test case đạt PASS (100\%). Không có trường hợp thất bại. Kết quả cho thấy các API hoạt động ổn định, xử lý đúng các tình huống khác nhau và duy trì trạng thái session hiệu quả. 
